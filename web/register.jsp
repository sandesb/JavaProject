...
<html>
  ...
  <body>
    <div class="tv-1">
        ...
        <div class="welcome-to-screenhome1">Welcome To STREAMly. <a style="color: inherit;"href="index123.html">
        <span></span></a></div>
      <div class="dont-have-an-container1">
        ...
        <p class="get-your-subscription2">
          <span class="get-your-subscription3">Get Your Subscription</span>
        </p>
      </div>
        <form action="/Stream/LoginServ?page=existing" method="POST">
      <div class="E">Email-ID :</div>
      <div class="P">Password :</div>
      
      <input class="input-box-email1" type="text" name="username" placeholder="Enter Your Email" />
      <input
        class="input-box-password1"
        name="password"
    ...
    <button class="button-login1">
      <button class="login-label1"></button><b class="log-in1">Register</b>
    </button>
  </button>
  </form>
